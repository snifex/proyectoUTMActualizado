...
class EventosController {
    ...
    listOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const respuesta = yield database_1.default.query('SELECT * FROM eventos WHERE idEvento = ?', [id]);
    ...
    getEventosByProfesor(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let respuesta = yield database_1.default.query(`SELECT * FROM eventos WHERE idProfesor=${idProfesor} AND inicio>='${fechaIni}' AND fin<='${fechaFin}'`);
            res.json(respuesta);
        });
    }
}
