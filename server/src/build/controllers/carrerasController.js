...
class CarrerasController {
    ...
    actualizar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield database_1.default.query("UPDATE Carreras set ? WHERE codigoCarrera= ?", [req.body, codigoCarrera]);
            res.json(resp);
        });
    }
    eliminar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { codigoCarrera } = req.params;
            const resp = yield database_1.default.query(`DELETE FROM Carreras WHERE codigoCarrera= ${codigoCarrera}`);
            res.json(resp);
        });
    }
